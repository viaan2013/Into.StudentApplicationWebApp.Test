...
public class UKAboutYouStepDef {
	...
	public void I_am_in_AboutYou_session_of_UKapplicationform() throws Throwable {
		...
		driver.get("http://apply-test.intostudy.com/application/course/aCI3A000000CadzWAC");
	...
	public void I_select(String Countryofnationality) throws Throwable {
		 ...
		 * System.out.println(nationalitycount.size()); String Nationalitylist =
		 * driver.findElement(By.id("nationality")).getText();
	...
	@When("^I select \"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\",\"([^\"]*)\"$")
	public void I_select_(String line1, String line2, String line3, String town, String city, String state,
	...
	public void I_select_from_dropdown(String country) throws Throwable {
		 ...
		 * System.out.println("countrynames list" + countrynames); List<WebElement>
		 * countrycount = countryfield.getOptions();
	...
	public void I_should_see_additional_information_session_of_application_form() throws Throwable {
		...
		driver.findElement(By.xpath("//a[@id='tabforotherinformation']/div[2]")).click();
		String actual = driver.findElement(By.xpath("//a[@id='tabforotherinformation']/div[2]")).getText();
		System.out.println(actual);
		String expectedtext = "Additional information";
		Assert.assertFalse(actual.contains(expectedtext));
